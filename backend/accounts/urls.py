...
user_patterns = [
    ...
    path('complete-account-setup/', views.CompleteAccountSetupView.as_view(), name='complete_account_setup'),
    ...
    path('body-measurements/', views.BodyMeasurementView.as_view(), name='body_measurements'),
